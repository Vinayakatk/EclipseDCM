...
public interface Docker extends EObject
{
   ...
   * The list contents are of type {@link org.eclipse.docker.language.container.ImportContainer}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.docker.language.container.ContainerPackage#getDocker_Imports()
   * @model containment="true"
   * @generated
   */
  EList<ImportContainer> getImports();
   ...
   * @see #setRuntime(RunContainerDefination)
   * @see org.eclipse.docker.language.container.ContainerPackage#getDocker_Runtime()
   * @model containment="true"
   * @generated
   */
  RunContainerDefination getRuntime();

  /**
   * Sets the value of the '{@link org.eclipse.docker.language.container.Docker#getRuntime <em>Runtime</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setRuntime(RunContainerDefination value);
