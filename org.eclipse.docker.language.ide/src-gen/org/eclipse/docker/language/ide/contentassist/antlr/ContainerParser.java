		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDockerAccess().getBuildAssignment_1_2(), "rule__Docker__BuildAssignment_1_2");
					put(grammarAccess.getDockerAccess().getRuntimeAssignment_1_3(), "rule__Docker__RuntimeAssignment_1_3");
