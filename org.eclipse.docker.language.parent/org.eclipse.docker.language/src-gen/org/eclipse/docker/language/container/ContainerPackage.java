...
public interface ContainerPackage extends EPackage
{
   ...
   * @ordered
   */
  int DOCKER__CONTAINER_REGION = 1;
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.docker.language.container.impl.RunContainerDefinationImpl
   ...
   * @ordered
   */
  int RUN_CONTAINER_DEFINATION__SEQUENCE = 0;

  /**
   * The number of structural features of the '<em>Run Container Defination</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int RUN_CONTAINER_DEFINATION_FEATURE_COUNT = 1;

  /**
   * The meta object id for the '{@link org.eclipse.docker.language.container.impl.ImportContainerImpl <em>Import Container</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.docker.language.container.impl.ImportContainerImpl
   ...
   * @ordered
   */
  int IMPORT_CONTAINER__IMPORTED_NAMESPACE = 0;
   ...
   * @ordered
   */
  int IMPORT_CONTAINER__IMPORT_URI = 1;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.eclipse.docker.language.container.Docker#getImports <em>Imports</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Imports</em>'.
   * @see org.eclipse.docker.language.container.Docker#getImports()
   * @see #getDocker()
   * @generated
   */
  EReference getDocker_Imports();
   ...
   * @see org.eclipse.docker.language.container.Docker#getRuntime()
   * @see #getDocker()
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Run Container Defination</em>'.
   * @see org.eclipse.docker.language.container.RunContainerDefination
   * @generated
   */
  EClass getRunContainerDefination();

  /**
   * Returns the meta object for the reference list '{@link org.eclipse.docker.language.container.RunContainerDefination#getSequence <em>Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Sequence</em>'.
   * @see org.eclipse.docker.language.container.RunContainerDefination#getSequence()
   * @see #getRunContainerDefination()
   * @generated
   */
  EReference getRunContainerDefination_Sequence();

  /**
   * Returns the meta object for class '{@link org.eclipse.docker.language.container.ImportContainer <em>Import Container</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Import Container</em>'.
   * @see org.eclipse.docker.language.container.ImportContainer
   * @generated
   */
  EClass getImportContainer();

  /**
   * Returns the meta object for the attribute '{@link org.eclipse.docker.language.container.ImportContainer#getImportedNamespace <em>Imported Namespace</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Imported Namespace</em>'.
   * @see org.eclipse.docker.language.container.ImportContainer#getImportedNamespace()
   * @see #getImportContainer()
   * @generated
   */
  EAttribute getImportContainer_ImportedNamespace();

  /**
   * Returns the meta object for the attribute '{@link org.eclipse.docker.language.container.ImportContainer#getImportURI <em>Import URI</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Import URI</em>'.
   * @see org.eclipse.docker.language.container.ImportContainer#getImportURI()
   * @see #getImportContainer()
   * @generated
   */
  EAttribute getImportContainer_ImportURI();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference DOCKER__IMPORTS = eINSTANCE.getDocker_Imports();
     ...
     * @generated
     */
    EClass RUN_CONTAINER_DEFINATION = eINSTANCE.getRunContainerDefination();
     ...
     * @generated
     */
    EReference RUN_CONTAINER_DEFINATION__SEQUENCE = eINSTANCE.getRunContainerDefination_Sequence();

    /**
     * The meta object literal for the '{@link org.eclipse.docker.language.container.impl.ImportContainerImpl <em>Import Container</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.docker.language.container.impl.ImportContainerImpl
     * @see org.eclipse.docker.language.container.impl.ContainerPackageImpl#getImportContainer()
     ...
     * @generated
     */
    EAttribute IMPORT_CONTAINER__IMPORTED_NAMESPACE = eINSTANCE.getImportContainer_ImportedNamespace();
     ...
     * @generated
     */
    EAttribute IMPORT_CONTAINER__IMPORT_URI = eINSTANCE.getImportContainer_ImportURI();
