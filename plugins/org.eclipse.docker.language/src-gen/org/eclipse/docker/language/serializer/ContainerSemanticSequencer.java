...
public class ContainerSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ContainerPackage.eINSTANCE)
			...
			case ContainerPackage.IMAGE_SECTION:
				...
				return; 
			case ContainerPackage.IMPORT_CONTAINER:
				sequence_ImportContainer(context, (ImportContainer) semanticObject); 
				return; 
			...
			case ContainerPackage.RUN_CONTAINER_DEFINATION:
				sequence_RunContainerDefination(context, (RunContainerDefination) semanticObject); 
				return; 
	 ...
	 */
	protected void sequence_ContainerSection(ISerializationContext context, ContainerSection semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *         (
	 *             imports+=ImportContainer+ 
	 *             (containerRegion=ContainerSection | imageRegion=ImageSection | build=BuildImagesExecution | runtime=RunContainerDefination)+
	 *         )
	 *     )?
	 */
	...
	/**
	 * Contexts:
	 *     ImageSection returns ImageSection
	 *
	 * Constraint:
	 *     (name=ID images+=Image*)
	 */
	protected void sequence_ImageSection(ISerializationContext context, ImageSection semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     ImportContainer returns ImportContainer
	 *
	 * Constraint:
	 *     (importedNamespace=ImportedFQN importURI=STRING)
	 */
	protected void sequence_ImportContainer(ISerializationContext context, ImportContainer semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ContainerPackage.Literals.IMPORT_CONTAINER__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ContainerPackage.Literals.IMPORT_CONTAINER__IMPORTED_NAMESPACE));
			if (transientValues.isValueTransient(semanticObject, ContainerPackage.Literals.IMPORT_CONTAINER__IMPORT_URI) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ContainerPackage.Literals.IMPORT_CONTAINER__IMPORT_URI));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getImportContainerAccess().getImportedNamespaceImportedFQNParserRuleCall_1_0_0(), semanticObject.getImportedNamespace());
		feeder.accept(grammarAccess.getImportContainerAccess().getImportURISTRINGTerminalRuleCall_2_0(), semanticObject.getImportURI());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     RunContainerDefination returns RunContainerDefination
	 *
	 * Constraint:
	 *     (sequence+=[Container|ID] sequence+=[Container|ID]*)
	 */
	protected void sequence_RunContainerDefination(ISerializationContext context, RunContainerDefination semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
